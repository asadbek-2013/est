...
const Contact = () => {
  return (
    <div className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden  dark:text-white dark:bg-black' id='Contact'>
      ...
      <form className='max-w-2xl mx-auto text-gray-600 pt-8  dark:text-white dark:bg-black'>
